function trajectory_plot(var,mode,mapgeneID,meanG,semG,mapTFID,meanTF,semTF)
...
if strcmp(mode, 'gene')
    ...
    box on
    x = 10:2000;
    y = meanG{6}(10:2000,mapgeneID(var))';
    sd = semG{6}(10:2000,mapgeneID(var))';
    plot(x, y, 'color', Acol)
    hold on 
    ...
    hold on 
    y = meanG{5}(10:2000,mapgeneID(var))';
    sd = semG{5}(10:2000,mapgeneID(var))';
    plot(x, y, 'color', Bcol)
    hold on 
...
elseif strcmp(mode, 'tf')
    ...
    box on
    x = 10:2000;
    y = meanTF{6}(10:2000,mapTFID(var))';
    sd = semTF{6}(10:2000,mapTFID(var))';
    plot(x, y, 'color', Acol)
    hold on 
    patch([x fliplr(x)], [y-sd  fliplr(y+sd)], Acol, 'EdgeColor','none'), alpha(0.5)
    axis tight
    ...
    hold on 
    y = meanTF{5}(10:2000,mapTFID(var))';
    sd = semTF{5}(10:2000,mapTFID(var))';
    plot(x, y, 'color', Bcol)
    hold on 
    patch([x fliplr(x)], [y-sd  fliplr(y+sd)], Bcol, 'EdgeColor','none'), alpha(0.5)
    axis tight
